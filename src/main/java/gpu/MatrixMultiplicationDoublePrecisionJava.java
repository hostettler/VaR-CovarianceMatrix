...
public class MatrixMultiplicationDoublePrecisionJava implements MatrixMultiplicationDoublePrecision {
	 ...
	 */
	public MatrixMultiplicationDoublePrecisionJava(double[] matrixA, int matrixAWidth, int matrixAHeight, boolean transposeMatrixA,
	...
	private void computeMatrixColumn(int resultColumnIndex) {
		...
		for (int lineInA = 0; lineInA < this.matrixAHeight; lineInA++) {
			...
			for (int columnInB = 0; columnInB < this.matrixBHeight; columnInB++) {
				double a = get(matrixA, matrixAWidth, matrixAHeight, columnInB,  lineInA, isMatrixATranspose);
				double b = get(matrixB, matrixBWidth, matrixBHeight, resultColumnIndex, columnInB, isMatrixBTranspose);
